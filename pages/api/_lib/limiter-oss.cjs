// pages/api/_lib/limiter-oss.cjs
// Rate-limit pe IP stocat în APS OSS/S3 (prin proxy). CommonJS + safe la build.
...
/**
 * checkAndConsumeIp
 * - crește contorul pentru ip în ziua curentă (UTC).
 * returnează { ok, remaining, used, resetAt, key }
 */
async function checkAndConsumeIp(req, limit = 2) {
