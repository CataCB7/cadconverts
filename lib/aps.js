// /lib/aps.js
const APS_BASE = "https://developer.api.autodesk.com"; // pentru buckets (details/create)
const APS_OSS  = "https://oss.api.autodesk.com";       // pentru upload obiecte
...
export async function ensureBucket(token, bucketKey = process.env.APS_BUCKET, policyKey = "persistent") {
  // folosim hostul "developer" pentru buckets
  const det = await fetch(`${APS_BASE}/oss/v2/buckets/${bucketKey}/details`, {
    method: "GET",
    headers: {
...
export const APS_OSS_URL  = APS_OSS;
